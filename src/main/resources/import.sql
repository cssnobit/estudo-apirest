...
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id) values ('Thaitai Restaurante', 10.0, 1, 1);
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id) values ('Tandoor Indian Food', 12.0, 2, 3);
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id) values ('Reet Namaste Brasil', 11.50, 2, 2);
